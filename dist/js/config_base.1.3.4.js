...
//#region 分组下的笔记列表页
{
    ...
    PUB.listCF.detail_group_note = _extends({}, PUB.cfListGPublic, {
...
//#region 分组下的网址列表页
{
    ...
    PUB.listCF.detail_group_url = _extends({}, PUB.cfListGPublic, {
...
//#region 分组下的视频列表页
{
    ...
    PUB.listCF.detail_group_vedio = _extends({}, PUB.cfListGPublic, {
