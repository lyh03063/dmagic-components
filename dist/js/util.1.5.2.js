                                ...
                                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                                    while (1) {
                                        switch (_context4.prev = _context4.next) {
                                            case 0:
                                                _context4.next = 2;
                                                return _this.$confirm("确定导出excel文件？每次只能导出一页，您可以在右下角选择每页显示更多的数据来提高导出效率").catch(function () {});
            ...
            while (1) {
                switch (_context7.prev = _context7.next) {
                    case 0:
                        ...
                        random = util.getTimeRandom(); //调用：{返回带时间戳的随机数函数}
                    ...
                    case 5:
                        ...
                        return _context7.abrupt("return", requestData);
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
            while (1) {
                switch (_context8.prev = _context8.next) {
                    ...
                    case 5:
                        requestData = _context8.sent;
                        return _context8.abrupt("return", requestData);
...
util.deleteQiNiuFile = function () {
    var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(url) {
        var _ref18, data;
...
//#region handleCommonListCF:处理通用列表配置数据函数
util.handleCommonListCF = function (_ref19) {
    var _dataType = _ref19._dataType,
        listCFAddon = _ref19.listCFAddon;
...
util.ajaxAddFileBaseInfo = function () {
    var _ref20 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(param) {
        var _dataAdd;

        var fileSource, responseQiniu, fileUrl, systemId, title, fileSize, fileExt, imgWidth, imgHeight, fileBucket, uploadTime, fileKey, dataAdd;
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
            while (1) {
                switch (_context10.prev = _context10.next) {
                    case 0:
                        fileSource = param.fileSource, responseQiniu = param.responseQiniu, fileUrl = param.fileUrl;
                        systemId = lodash.get(PUB, "_paramAjaxAddon._systemId", PUB._systemId);
                        title = responseQiniu.fname, fileSize = responseQiniu.size, fileExt = responseQiniu.ext, imgWidth = responseQiniu.w, imgHeight = responseQiniu.h, fileBucket = responseQiniu.bucket, uploadTime = responseQiniu.time, fileKey = responseQiniu.key;
                        dataAdd = (_dataAdd = {
                            title: title, fileKey: fileKey, fileSize: fileSize, fileExt: fileExt, imgWidth: imgWidth, imgHeight: imgHeight,
                            fileBucket: fileBucket }, _defineProperty(_dataAdd, "fileKey", fileKey), _defineProperty(_dataAdd, "uploadTime", uploadTime), _defineProperty(_dataAdd, "fileSource", fileSource), _defineProperty(_dataAdd, "link", fileUrl), _defineProperty(_dataAdd, "systemId", systemId), _dataAdd);
                        _context10.next = 6;
                        return axios({
...
util.ajaxDeleteBaseFile = function () {
    var _ref21 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(url) {
        var _ref22, doc, _id, _systemId, _ref23, data;
            ...
            while (1) {
                switch (_context11.prev = _context11.next) {
                    ...
                    case 2:
                        ...
                        return _context11.abrupt("return", console.warn("未找到对应的基础文件数据"));

                    case 6:
                        _id = doc._id, _systemId = doc._systemId;
                        _context11.next = 9;
                        return axios({ //删除单条数据
                            method: "post", url: PUB.domain + "/info/commonDelete", data: { _id: _id, _systemId: _systemId, "_dataType": "file_base" }
                        });
