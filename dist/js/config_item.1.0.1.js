...
DYDICT.arr_dataType = [{ label: "课堂笔记", value: "note" }, { label: "前端demo", value: "front_demo" }, { label: "习题", value: "exercises" }, { label: "分组", value: "group" }, { label: "HtmlApi", value: "html_api" }, { label: "Js-Api", value: "js_api" }, { label: "Css-Api", value: "css_api" }, { label: "视频", value: "vedio" }, { label: "网址", value: "url" }];
