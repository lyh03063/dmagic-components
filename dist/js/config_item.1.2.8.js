...
//#region 支付状态
{
    var _prop2 = "payStatus",
        _objBase4 = { label: "支付状态", prop: _prop2 };
    D_ITEMS[_prop2] = _extends({}, _objBase4, {
        formatter: function formatter(rowData) {
            return lodash.get(DYDICT.payStatus, rowData.payStatus + ".label");
        }
    });
    COLUMNS[_prop2] = _extends({}, _objBase4, { width: 70,
        formatter: function formatter(rowData) {
            return lodash.get(DYDICT.payStatus, rowData.payStatus + ".label");
        }
    });

    COLUMNS.payStatus_slot = _extends({}, _objBase4, { slot: "slot_column_payStatus", width: 130 });
    COLUMNS.payStatus_com = _extends({}, _objBase4, { component: "com_c_item_payStatus", width: 130 });
    F_ITEMS[_prop2] = _extends({}, _objBase4, { type: "select", options: DYDICT.arr_payStatus });
...
//#region 标题
{
    ...
    D_ITEMS.title = _extends({}, _objBase5);
    COLUMNS.title_fixed = _extends({}, _objBase5, { width: 320, fixed: true });
    COLUMNS.title = _extends({}, _objBase5, { width: 200 });
    COLUMNS.title_w250 = _extends({}, _objBase5, { width: 250 });
    COLUMNS.title_w300 = _extends({}, _objBase5, { width: 300 });
    COLUMNS.title_w100 = _extends({}, _objBase5, { width: 100 });
    COLUMNS.title_w150 = _extends({}, _objBase5, { width: 150 });
    COLUMNS.title_w200 = _extends({}, _objBase5, { width: 200 });
    F_ITEMS.title = _extends({}, _objBase5);
    F_ITEMS.title_search = _extends({}, _objBase5, { type: "input_find_vague" });
...
//#region 时间段1(日范围)
{
    var _prop3 = "prop_time_period1",
        _objBase6 = { label: "时间段(日范围)", prop: _prop3 };
...
//#region 时间段2(月范围)
{
    var _prop4 = "prop_time_period2",
        _objBase7 = { label: "时间段(月范围)", prop: _prop4 };
...
//#region 时间段3(年)
{
    var _prop5 = "prop_time_period3",
        _objBase8 = { label: "时间段(年)", prop: _prop5 };
    D_ITEMS[_prop5] = _extends({}, _objBase8);
    COLUMNS[_prop5] = _extends({}, _objBase8, { width: 70 });
    F_ITEMS[_prop5] = _extends({}, _objBase8, { type: "time_period",
        cfItem: {
            //两层配置结构，为了更好拓展
            "cfDataPicker": {
                "type": "year",
...
//#region 单文件上传
{
    var _prop6 = "upload_single1",
        _objBase9 = { label: "单文件上传", prop: _prop6 };
...
//#region 头像上传2
{
    var _prop7 = "uploadAvatar",
        _objBase10 = { label: "头像上传", prop: _prop7 };
    D_ITEMS[_prop7] = _extends({}, _objBase10);
    COLUMNS[_prop7] = _extends({}, _objBase10, { width: 70 });
    F_ITEMS[_prop7] = _extends({}, _objBase10, { type: "upload_single",
        cfItem: {
            isAvatar: true, //头像
            //两层配置结构，为了更好拓展
            "cfUpload": {}
...
COLUMNS.personCharge = _extends({}, D_ITEMS.personCharge, { width: 70,
    formatter: function formatter(row) {
        ...
        var arr1 = util.clearArr(row.adminDoc); //调用：{清除数组中的无效元素（null,undefined,空格等）}
...
COLUMNS.timeOrder = _extends({}, D_ITEMS.timeOrder);
F_ITEMS.timeOrder__search = _extends({}, D_ITEMS.timeOrder, { type: "time_period" });
...
//#region 详细地址
{
    ...
    D_ITEMS[_prop8] = _extends({}, _objBase11);
    COLUMNS[_prop8] = _extends({}, _objBase11, { width: 120 });
    F_ITEMS[_prop8] = _extends({}, _objBase11, { type: "input" });
    F_ITEMS[_prop8 + "_search"] = _extends({}, _objBase11, { type: "input_find_vague" });
}
...
//#region icon地址
{
    ...
    D_ITEMS.iconSrc = _extends({}, _objBase12);
    COLUMNS.iconSrc = _extends({}, _objBase12, { width: 70 });
    F_ITEMS.iconSrc = _extends({}, _objBase12, { type: "upload_single" });
}
...
//#region 选择项目
{
    ...
    D_ITEMS.projectName = _extends({}, _objBase13);
    COLUMNS.projectName = _extends({}, _objBase13, { width: 70 });
    F_ITEMS.projectName_select_lazy = _extends({}, _objBase13, { type: "select_ajax_lazy",
        cfSelectAjaxLazy: {
...
//#region 生日
{
    ...
    D_ITEMS.birthday = _extends({}, _objBase14);
    COLUMNS.birthday = _extends({}, _objBase14, { width: 120 });
    F_ITEMS.birthday = _extends({}, _objBase14, { type: "date" });
}
...
//#region 头像
{
    ...
    D_ITEMS.headSrc = _extends({}, _objBase15);
    COLUMNS.headSrc = _extends({}, _objBase15, { width: 70 });
    F_ITEMS.headSrc = _extends({}, _objBase15, { type: "upload" });
}
...
//#region QQ号
{
    ...
    D_ITEMS[_prop9] = _extends({}, _objBase16);
    COLUMNS[_prop9] = _extends({}, _objBase16, { width: 70 });
    F_ITEMS[_prop9] = _extends({}, _objBase16, { type: "input" });
    F_ITEMS[_prop9 + "_search"] = _extends({}, _objBase16, { type: "input_find_vague" });
}
...
//#region 邮箱
{
    ...
    D_ITEMS[_prop10] = _extends({}, _objBase17);
    COLUMNS[_prop10] = _extends({}, _objBase17, { width: 100 });
    F_ITEMS[_prop10] = _extends({}, _objBase17, { type: "input" });
    F_ITEMS[_prop10 + "_search"] = _extends({}, _objBase17, { type: "input_find_vague" });
}
...
//#region 公司名
{
    ...
    D_ITEMS[_prop11] = _extends({}, _objBase18);
    COLUMNS[_prop11] = _extends({}, _objBase18, { width: 190 });
    F_ITEMS[_prop11] = _extends({}, _objBase18, { type: "input" });
    F_ITEMS[_prop11 + "_search"] = _extends({}, _objBase18, { type: "input_find_vague" });
}
...
//#region 微信号
{
    var _prop12 = "wxNumber",
        _objBase19 = { label: "微信号", prop: _prop12 };
    D_ITEMS[_prop12] = _extends({}, _objBase19);
    COLUMNS[_prop12] = _extends({}, _objBase19, { width: 70 });
    F_ITEMS[_prop12] = _extends({}, _objBase19, { type: "input" });
}
//#endregion
...
//#region 文件
{
    ...
    D_ITEMS.file = _extends({}, _objBase20);
    COLUMNS.file = _extends({}, _objBase20, { width: 190,
        formatter: function formatter(row) {
    ...
    F_ITEMS.file = _extends({}, _objBase20, { type: "upload",
        uploadConfig: {
            limit: 1,
            listType: "text"
        }
...
//#region 图片预览
{
    ...
    D_ITEMS.imagePreview = _extends({}, _objBase21, {
        component: "com_imagePreview"
    });
    COLUMNS.imagePreview = _extends({}, _objBase21, { width: 100, component: "com_imagePreview" });
}
...
//#region 公司名
{
    var _prop13 = "companyName";
    var _objBase22 = {
        label: "公司名",
        prop: _prop13
    };
    D_ITEMS[_prop13] = _extends({}, _objBase22);
    COLUMNS[_prop13] = _extends({}, _objBase22, { width: 190 });
    F_ITEMS[_prop13] = _extends({}, _objBase22, { type: "input" });
    F_ITEMS[_prop13 + "_search"] = _extends({}, _objBase22, { type: "input_find_vague" });
}
...
//#region 头像上传2
{
    var _prop14 = "avatarImg",
        _objBase23 = { label: "头像上传", prop: _prop14 };
    D_ITEMS[_prop14] = _extends({}, _objBase23);
    COLUMNS[_prop14] = _extends({}, _objBase23, { width: 70 });
    F_ITEMS[_prop14] = _extends({}, _objBase23, { type: "upload_single",
        cfItem: {
            isAvatar: true, //头像
            //两层配置结构，为了更好拓展
            "cfUpload": {}
...
//#region 职位名称
{
    var _prop15 = "positionName",
        _objBase24 = { label: "职位名称", prop: _prop15 };
    D_ITEMS[_prop15] = _extends({}, _objBase24);
    COLUMNS[_prop15] = _extends({}, _objBase24, { width: 100 });
    F_ITEMS[_prop15] = _extends({}, _objBase24, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
//#region 在职时间段
{
    var _prop16 = "onJobPeriod",
        _objBase25 = { label: "在职时间段", prop: _prop16 };
    D_ITEMS[_prop16] = _extends({}, _objBase25);
    COLUMNS[_prop16] = _extends({}, _objBase25, { width: 120 });
...
{
    var _prop17 = "descJob",
        _objBase26 = { label: "工作内容描述", prop: "descJob" };
    D_ITEMS[_prop17] = _extends({}, _objBase26);
    COLUMNS[_prop17] = _extends({}, _objBase26, { width: 170 });
    F_ITEMS[_prop17] = _extends({}, _objBase26, { type: "textarea" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
//#region 学校名称
{
    var _prop18 = "schoolName",
        _objBase27 = { label: "学校名称", prop: _prop18 };
    D_ITEMS[_prop18] = _extends({}, _objBase27);
    COLUMNS[_prop18] = _extends({}, _objBase27, { width: 170 });
...
//#region 在校时间段
{
    var _prop19 = "inSchoolPeriod",
        _objBase28 = { label: "在校时间段", prop: _prop19 };
    D_ITEMS[_prop19] = _extends({}, _objBase28);
    COLUMNS[_prop19] = _extends({}, _objBase28, { width: 120 });
    F_ITEMS[_prop19] = _extends({}, _objBase28, { type: "time_period",
        cfItem: {
            keyStart: "start",
            keyEnd: "end",
            //两层配置结构，为了更好拓展
...
{
    var _prop20 = "diploma",
        _objBase29 = { label: "学历", prop: _prop20 };
    D_ITEMS[_prop20] = _extends({}, _objBase29);
    COLUMNS[_prop20] = _extends({}, _objBase29, { width: 70 });
    F_ITEMS[_prop20] = _extends({}, _objBase29, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
//#region 专业名称
{
    var _prop21 = "professionalName",
        _objBase30 = { label: "专业名称", prop: _prop21 };
    D_ITEMS[_prop21] = _extends({}, _objBase30);
    COLUMNS[_prop21] = _extends({}, _objBase30, { width: 130 });
...
//#region 完成度-查询
{
    var _prop22 = "complete_search",
        _objBase31 = { label: "完成度", prop: _prop22 };
    D_ITEMS[_prop22] = _extends({}, _objBase31);
    COLUMNS[_prop22] = _extends({}, _objBase31, { width: 130 });
    F_ITEMS[_prop22] = _extends({}, _objBase31, { component: "com_item_complete_search" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
//#region 系统编号
{
    var _prop23 = "systemId",
        _objBase32 = { label: "系统编号", prop: _prop23 };
    D_ITEMS[_prop23] = _extends({}, _objBase32);
    COLUMNS[_prop23] = _extends({}, _objBase32, { width: 100 });
...
{
    var _prop25 = "logoSrc",
        _objBase34 = { label: "站点logo", prop: _prop25 };
    D_ITEMS[_prop25] = _extends({}, _objBase34);
    COLUMNS[_prop25] = _extends({}, _objBase34, { width: 70 });
    F_ITEMS[_prop25] = _extends({}, _objBase34, { type: "upload_single",
        cfItem: {
            isAvatar: true, //头像
            //两层配置结构，为了更好拓展
            "cfUpload": {}
...
//#region 收货人
{
    ...
    D_ITEMS.receiverName = _extends({}, _objBase35);
    COLUMNS.receiverName = _extends({}, _objBase35, { width: 70 });
    F_ITEMS.receiverName = _extends({}, _objBase35, { type: "input" });
}
...
{
    var _prop26 = "icon",
        _objBase36 = { label: "图标样式名", prop: _prop26 };

    D_ITEMS["menuIcon"] = _extends({}, _objBase36);
    COLUMNS["menuIcon"] = _extends({}, _objBase36, { width: 70 });
    F_ITEMS["menuIcon"] = _extends({}, _objBase36, { type: "input" });
}
//#endregion
...
{
    var _prop27 = "index",
        _objBase37 = { label: "菜单索引值", prop: _prop27 };
    D_ITEMS["menuIndex"] = _extends({}, _objBase37);
    COLUMNS["menuIndex"] = _extends({}, _objBase37, { width: 70 });
    F_ITEMS["menuIndex"] = _extends({}, _objBase37, { type: "input",
        tips: "该值不允许重复"
    });
}
//#endregion
...
{
    var _prop28 = "route",
        _objBase38 = { label: "路由地址", prop: _prop28 };
    D_ITEMS["menuRoute"] = _extends({}, _objBase38);
    COLUMNS["menuRoute"] = _extends({}, _objBase38, { width: 70 });
    F_ITEMS["menuRoute"] = _extends({}, _objBase38, { type: "input" });
}
//#endregion
...
//#region 树状数据
{
    var _prop29 = "treeData1",
        _objBase39 = { label: "树状数据", prop: _prop29 };
    D_ITEMS[_prop29] = _extends({}, _objBase39);
    COLUMNS[_prop29] = _extends({}, _objBase39, { width: 70 });
    F_ITEMS[_prop29] = _extends({}, _objBase39, {
        type: "tree_data"
    });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
...
//#region 树状数据
{
    var _prop30 = "treeDataMenu",
        _objBase40 = { label: "菜单数据", prop: _prop30 };
    D_ITEMS[_prop30] = _extends({}, _objBase40);
    COLUMNS[_prop30] = _extends({}, _objBase40, { width: 70 });
    F_ITEMS[_prop30] = _extends({}, _objBase40, { type: "tree_data",
        cfItem: {
            idKey: "index",
            //两层配置
            cfTree: {
...
{
    var _prop31 = "aaaa",
        _objBase41 = { label: "0000", prop: _prop31 };
    D_ITEMS[_prop31] = _extends({}, _objBase41);
    COLUMNS[_prop31] = _extends({}, _objBase41, { width: 70 });
    F_ITEMS[_prop31] = _extends({}, _objBase41, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
{
    var _prop32 = "aaaa",
        _objBase42 = { label: "0000", prop: _prop32 };
    D_ITEMS[_prop32] = _extends({}, _objBase42);
    COLUMNS[_prop32] = _extends({}, _objBase42, { width: 70 });
    F_ITEMS[_prop32] = _extends({}, _objBase42, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
{
    var _prop33 = "aaaa",
        _objBase43 = { label: "0000", prop: _prop33 };
    D_ITEMS[_prop33] = _extends({}, _objBase43);
    COLUMNS[_prop33] = _extends({}, _objBase43, { width: 70 });
    F_ITEMS[_prop33] = _extends({}, _objBase43, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
{
    var _prop34 = "aaaa",
        _objBase44 = { label: "0000", prop: _prop34 };
    D_ITEMS[_prop34] = _extends({}, _objBase44);
    COLUMNS[_prop34] = _extends({}, _objBase44, { width: 70 });
...
{
    var _prop35 = "aaaa",
        _objBase45 = { label: "0000", prop: _prop35 };
    D_ITEMS[_prop35] = _extends({}, _objBase45);
    COLUMNS[_prop35] = _extends({}, _objBase45, { width: 70 });
...
{
    var _prop36 = "aaaa",
        _objBase46 = { label: "0000", prop: _prop36 };
    D_ITEMS[_prop36] = _extends({}, _objBase46);
    COLUMNS[_prop36] = _extends({}, _objBase46, { width: 70 });
    F_ITEMS[_prop36] = _extends({}, _objBase46, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
{
    var _prop37 = "aaaa",
        _objBase47 = { label: "0000", prop: _prop37 };
...
{
    var _prop38 = "aaaa",
        _objBase48 = { label: "0000", prop: _prop38 };
    D_ITEMS[_prop38] = _extends({}, _objBase48);
    COLUMNS[_prop38] = _extends({}, _objBase48, { width: 70 });
    F_ITEMS[_prop38] = _extends({}, _objBase48, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
...
{
    var _prop39 = "aaaa",
        _objBase49 = { label: "0000", prop: _prop39 };
    D_ITEMS[_prop39] = _extends({}, _objBase49);
    COLUMNS[_prop39] = _extends({}, _objBase49, { width: 70 });
    F_ITEMS[_prop39] = _extends({}, _objBase49, { type: "input" });
    // F_ITEMS[`${prop}_search`] = { ...objBase, type: "input_find_vague" };
}
//#endregion
