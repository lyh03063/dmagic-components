...
//#region 文章分类列表页
{
    ...
    var _dataType4 = "article_category";
...
//#region 角色列表页
{
    ...
    PUB.listCF.list_role = _extends({
        ...
        searchFormItems: [F_ITEMS.Id],
        //-------详情字段数组-------
        detailItems: [D_ITEMS.Id, D_ITEMS.roleName, D_ITEMS.rolePower],
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.roleName, F_ITEMS.rolePower]
    });
}
//#endregion
//#region 网址列表页
