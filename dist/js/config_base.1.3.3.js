...
//#region 分组列表页
{
    ...
    PUB.listCF.list_group = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: ["title", "alias", "group_dataType", "desc", "iconSrc"]
...
PUB.singleBtns_list_group_data = {
    addon: [util.cfList.sBtns.detail, util.cfList.sBtns.copyEntity, util.cfList.sBtns.delete].concat(_toConsumableArray(util.cfList.sBtns.arrSortBtns), [util.cfList.sBtns.detailEntity])
};
...
PUB.cfListGPublic = _extends({
    ...
    batchBtns: {
        addon: [{ uiType: "slot", slot: "slot_btn_select" }, util.cfList.bBtns.addEntity, util.cfList.bBtns.add, util.cfList.bBtns.delete]
    },
    ...
    PUB.listCF.detail_group_group = _extends({}, PUB.cfListGPublic, {
        ...
        singleBtns: {
            ...
            util.cfList.sBtns.modify, util.cfList.sBtns.copy, util.cfList.sBtns.delete].concat(_toConsumableArray(util.cfList.sBtns.arrSortBtns), [util.cfList.sBtns.linkGroup])
        },
        sortJsonDefault: {
            "sort": -1
        },
