...
//#region 列表模块名数组配置
PUB.arrListName = ["admin", "role", "html_api", "html_api_category", "css_api", "css_api_category", "js_api", "js_api_category", "url", "article", "article_category", "note", "note_category", "vedio", "familiarity", "relation", "group", "all", "data_type", "exercises", "front_demo", "project_case"];
//#endregion
