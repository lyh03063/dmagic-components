...
//#region 管理员列表页
{
    ...
    PUB.listCF.list_admin = _extends({
        ...
        //-------列配置数组-------
        columns: [COLUMNS.Id, COLUMNS.userName, COLUMNS.passWord, COLUMNS.nickName, COLUMNS.role],
        //-------筛选表单字段数组-------
        searchFormItems: [F_ITEMS.Id],
        //-------详情字段数组-------
        detailItems: [D_ITEMS.Id, D_ITEMS.userName, D_ITEMS.passWord],
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.userName, F_ITEMS.passWord, F_ITEMS.nickName, F_ITEMS.role]
    });
}
//#endregion
...
//#region 所有数据列表页
{
    ...
    PUB.listCF.list_all = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.title, F_ITEMS.desc]
    });
}
//#endregion
...
//#region 文章分类列表页
{
    ...
    PUB.listCF.list_article_category = _extends({
        ...
        //-------列配置数组-------
        columns: [COLUMNS.category_name, COLUMNS.category_remark],
        //-------筛选表单字段数组-------
        searchFormItems: [F_ITEMS.category_name],
        //-------详情字段数组-------
        detailItems: [D_ITEMS.category_name, D_ITEMS.category_remark],
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.category_name, F_ITEMS.category_remark]
    });
}
//#endregion
...
//#region 数据类型列表页
{
    ...
    PUB.listCF.list_data_type = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.dataTypekey, F_ITEMS.title, F_ITEMS.desc]
    });
}
//#endregion
...
//#region 笔记列表页
{
    ...
    PUB.listCF.list_note = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.title, F_ITEMS.link, F_ITEMS.importance_radio, F_ITEMS.difficulty_radio, F_ITEMS.keyword, F_ITEMS.note_category, F_ITEMS.desc, F_ITEMS.detail]
    });
}
//#endregion
...
//#region 角色列表页
{
    ...
    PUB.listCF.list_role = _extends({
        ...
        columns: [COLUMNS.Id, COLUMNS.roleName, COLUMNS.rolePower],
        //-------筛选表单字段数组-------
        searchFormItems: [F_ITEMS.Id],
        //-------详情字段数组-------
        detailItems: [COLUMNS.Id, COLUMNS.roleName, COLUMNS.rolePower],
        //-------新增、修改表单字段数组-------
        formItems: [COLUMNS.roleName, COLUMNS.rolePower]
    });
}
//#endregion
...
//#region 网址列表页
{
    ...
    PUB.listCF.list_url = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.title, F_ITEMS.link, F_ITEMS.desc, F_ITEMS.album]
    });
}
//#endregion
...
//#region 视频列表页
{
    ...
    PUB.listCF.list_vedio = _extends({
        ...
        //-------新增、修改表单字段数组-------
        formItems: [F_ITEMS.title, F_ITEMS.keyword, F_ITEMS.desc, F_ITEMS.link, F_ITEMS.vedio]
    });
}
//#endregion
...

{
    ...
    PUB.listCF.detail_group_group = _extends({
        ...
        columns: [
        // COLUMNS._idRel2,
        COLUMNS.title_fixed, COLUMNS.countData, COLUMNS.myScore, COLUMNS.group_dataType, COLUMNS.desc, COLUMNS.sort],
        //-------筛选表单字段数组-------
        searchFormItems: [],
        //-------详情字段数组-------
...
//#region 分组下的笔记列表页
{
    ...
    PUB.listCF.detail_group_note = _extends({
        ...
        COLUMNS.familiarity_select, COLUMNS.importance, COLUMNS.difficulty, COLUMNS.category_multiple, COLUMNS.sort],
        //-------筛选表单字段数组-------
