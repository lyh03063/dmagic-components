...
util.ajaxPopulate = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(populateConfig) {
        var ajax, listData, page, populateColumn, idColumn, idColumn2, _populateConfig$findJ, findJson, arrId, findJsonNeed, urlAjax, paramAjax, url, _ajax$param, param, _ref2, data, dict;
