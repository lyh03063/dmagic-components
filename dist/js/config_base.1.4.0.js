...
PUB.cfListGPublic = _extends({
    ...
    var listIndex = "detail_group_group";
    PUB.listCF[listIndex] = _extends({}, PUB.cfListGPublic, {
...
//#region 分组下的笔记列表页
{
    ...
    var _listIndex = "detail_group_note";
    PUB.listCF[_listIndex] = _extends({}, PUB.cfListGPublic, {
...
//#region 分组下的网址列表页
{
    ...
    var _listIndex2 = "detail_group_url";
    PUB.listCF[_listIndex2] = _extends({}, PUB.cfListGPublic, {
...
//#region 分组下的视频列表页
{
    ...
    var _listIndex3 = "detail_group_vedio";
    PUB.listCF[_listIndex3] = _extends({}, PUB.cfListGPublic, {
