...
F_ITEMS.complete_search = {"prop":"complete_search","label":"完成度","componentName":"com_item_complete_search"};
//字段auditStatus:审核状态
...
F_ITEMS._systemId = {"prop":"_systemId","label":"系统Id","ajax":{ param: { _systemId, _dataType: "system" }, url: "/info/getCommonList", keyLabel: "title", keyValue: "systemId", },"multiple":true};
//字段uploadTime:上传时间
...
F_ITEMS.complete = {"prop":"complete","label":"完成度","componentName":"com_item_complete_search"};
...
D_ITEMS.imagePreview = {"prop":"imagePreview","label":"图片预览","componentName":"com_imagePreview","slotName":""}; 

COLUMNS.imagePreview = {"prop":"imagePreview","label":"图片预览","width":100,"componentName":"com_imagePreview","edit":false,"fixed":false};
...
F_ITEMS.num1_component = {"prop":"num1","label":"设置component","componentName":"el-input"};
...
F_ITEMS.listSpecPrice = {"prop":"listSpecPrice","label":"规格/价格表","componentName":"com_f_item_listSpecPrice"};
//字段objSpecTerm:规格条件
...
COLUMNS.extend = {"prop":"extend","label":"","width":235,"fixed":false,"edit":false};
...
F_ITEMS.countOrder = {"prop":"countOrder","label":"","type":"number"};
//字段isPublish:是否发布
...
COLUMNS.familiarity_select = {"prop":"familiarity","label":"","width":120,"componentName":"com_note_familiarity_select","fixed":false,"edit":false,"cfColumn":{ "class-name": "table_cell_visible" }};
...
F_ITEMS.collection_DYDICT_value = {"prop":"arrItem","label":"值项","componentName":"","type":"collection","collectionCfForm":{ col_span: 8, formItems: [{ label: "标签名", prop: "label", }, { label: "值", prop: "value" } ] },"cfElBtnAdd":{ text: "+添加一组", type: "primary", size: "mini", plain: false }};
//字段addressObj:收货地址
 
 
D_ITEMS.addressObj = {"prop":"addressObj","label":"收货地址","componentName":"com_addressObj"}; 
...
D_ITEMS.listGoods = {"prop":"listGoods","label":"商品清单","componentName":"com_listGoods"}; 
...
COLUMNS.personCharge = {"prop":"personCharge","label":"负责人","edit":false,"fixed":false,"width":70,"formatter":function () { if (!row.adminDoc) return; let arr1 = util.clearArr(row.adminDoc); let arrName = arr1.map(doc => doc.nickName); return arrName.join() }};
...
COLUMNS.complete = {"prop":"complete","label":"完成度","width":80,"componentName":"","slotName":"slot_column_complete","fixed":false,"edit":false};
COLUMNS.complete_com = {"prop":"complete","label":"完成度","width":80,"componentName":"com_complete","slotName":"","fixed":false,"edit":false};
...
COLUMNS.payStatus_com = {"prop":"payStatus","label":"支付状态","width":90,"componentName":"com_c_item_payStatus","fixed":false,"edit":false};
...
D_ITEMS.timeOrder = {"prop":"timeOrder","label":"","formatter":function (row) { if (!row.timeOrder) return ""; return moment(row.timeOrder).format("YYYY-MM-DD HH:mm") }}; 
