...
D_ITEMS.imagePreview = {"prop":"imagePreview","label":"图片预览","component":"com_imagePreview","slotName":""}; 

COLUMNS.imagePreview = {"prop":"imagePreview","label":"图片预览","width":100,"component":"com_imagePreview","edit":false,"fixed":false};
...
COLUMNS.familiarity_select = {"prop":"familiarity","label":"","width":120,"component":"com_note_familiarity_select","fixed":false,"edit":false,"cfColumn":{ "class-name": "table_cell_visible" }};
...
F_ITEMS.collection_DYDICT_value = {"prop":"arrItem","label":"值项","component":"","type":"collection","collectionCfForm":{ col_span: 8, formItems: [{ label: "标签名", prop: "label", }, { label: "值", prop: "value" } ] },"cfElBtnAdd":{ text: "+添加一组", type: "primary", size: "mini", plain: false }};
//字段addressObj:收货地址
...
COLUMNS.complete = {"prop":"complete","label":"完成度","width":80,"component":"","slotName":"slot_column_complete","fixed":false,"edit":false};
COLUMNS.complete_com = {"prop":"complete","label":"完成度","width":80,"component":"com_complete","slotName":"","fixed":false,"edit":false};
...
COLUMNS.payStatus_com = {"prop":"payStatus","label":"支付状态","width":90,"component":"com_c_item_payStatus","fixed":false,"edit":false};
