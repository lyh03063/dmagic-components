...
COLUMNS.importance = {"prop":"importance","label":"重要性","edit":false,"fixed":false,"width":70,"formatter":function (rowData) { return lodash.get(DYDICT.importance, `${rowData.importance}.label`); }};
COLUMNS.importance_edit = {"prop":"importance","label":"重要性","edit":true,"fixed":false,"width":70,"formatter":function (rowData) { return lodash.get(DYDICT.importance, `${rowData.importance}.label`); }};
...
D_ITEMS.timeOrder = {"prop":"timeOrder","label":"下单时间","formatter":function (row) { if (!row.timeOrder) return ""; return moment(row.timeOrder).format("YYYY-MM-DD HH:mm") }}; 

COLUMNS.timeOrder = {"prop":"timeOrder","label":"下单时间","item_width":130,"formatter":function (row) { if (!row.timeOrder) return ""; return moment(row.timeOrder).format("YYYY-MM-DD HH:mm") }};
...
COLUMNS.category = {"prop":"category","label":"所属分类","width":120,"fixed":false,"edit":false,"formatter":function (rowData) { let title = lodash.get(rowData, "categoryDoc.title"); return title; }};
COLUMNS.category_multiple = {"prop":"category","label":"所属分类","width":120,"fixed":false,"edit":false,"formatter":function (rowData) { if (!(rowData.categoryDoc && rowData.categoryDoc.length)) return ""; let arrCate = rowData.categoryDoc.map(doc => { return doc.title; }); return arrCate.join(); }};
...
COLUMNS.difficulty = {"prop":"difficulty","label":"难度","width":70,"fixed":false,"edit":false,"formatter":function (rowData) { return lodash.get(DYDICT.difficulty, `${rowData.difficulty}.label`); }};
COLUMNS.difficulty_edit = {"prop":"difficulty","label":"难度","width":70,"fixed":false,"edit":true,"formatter":function (rowData) { return lodash.get(DYDICT.difficulty, `${rowData.difficulty}.label`); }};
...
D_ITEMS.payStatus = {"prop":"payStatus","label":"支付状态","formatter":function (rowData) { return lodash.get(DYDICT.payStatus, `${rowData.payStatus}.label`); }}; 

COLUMNS.payStatus = {"prop":"payStatus","label":"支付状态","width":70,"fixed":false,"edit":false,"formatter":function (rowData) { return lodash.get(DYDICT.payStatus, `${rowData.payStatus}.label`); }};
...
COLUMNS.CreateTime = {"prop":"CreateTime","label":"创建时间","width":90,"fixed":false,"edit":false,"formatter":function (row) { if (!row.CreateTime) return ""; return moment(row.CreateTime).format("YYYY-MM-DD") }};
...
COLUMNS.deliveryStatus = {"prop":"deliveryStatus","label":"物流状态","width":70,"fixed":false,"edit":false,"formatter":function (rowData) { return lodash.get(DYDICT.deliveryStatus, `${rowData.deliveryStatus}.label`); }};
...
COLUMNS.orderSource = {"prop":"orderSource","label":"订单来源","width":70,"fixed":false,"edit":false,"formatter":function (rowData) { return lodash.get(DYDICT.orderSource, `${rowData.orderSource}.label`); }};
...
COLUMNS.prior = {"prop":"prior","label":"优先级","width":80,"fixed":false,"edit":false,"formatter":function (row) { return lodash.get(DYDICT.prior, `${row.prior}.label`); }};
...
COLUMNS.taskType = {"prop":"taskType","label":"任务类型","width":70,"fixed":false,"edit":false,"formatter":function (row) { return lodash.get(DYDICT.taskType, `${row.taskType}.label`); }};
...
COLUMNS.personCharge = {"prop":"personCharge","label":"负责人","edit":false,"fixed":false,"width":70,"formatter":function (row) { if (!row.adminDoc) return; let arr1 = util.clearArr(row.adminDoc); let arrName = arr1.map(doc => doc.nickName); return arrName.join() }};
...
COLUMNS.orderNickName = {"prop":"orderNickName","label":"下单人","width":70,"edit":false,"fixed":false,"formatter":function (row) { return lodash.get(row, `userDoc.nickName`); }};
...
D_ITEMS.refundStaus = {"prop":"refundStaus","label":"退款状态","formatter":function (rowData) { return lodash.get(DYDICT.refundStaus, `${rowData.refundStaus}.label`); }}; 

COLUMNS.refundStaus = {"prop":"refundStaus","label":"退款状态","width":80,"edit":false,"fixed":false,"formatter":function (rowData) { return lodash.get(DYDICT.refundStaus, `${rowData.refundStaus}.label`); }};
...
COLUMNS.franchiseeId = {"prop":"franchiseeId","label":"加盟商","width":100,"edit":false,"fixed":false,"formatter":function (rowData) { return lodash.get(rowData, `franchiseeDoc.name`); }};
...
COLUMNS.joinTime = {"prop":"joinTime","label":"加盟时间","width":130,"edit":false,"fixed":false,"formatter":function (row) { return moment(row.time).format("YYYY-MM-DD"); }};
...
COLUMNS.file = {"prop":"file","label":"文件","width":190,"edit":false,"fixed":false,"formatter":function (row) { return lodash.get(row, `file[0].url`, ""); }};
...
D_ITEMS.auditStatus = {"prop":"auditStatus","label":"审核状态","formatter":function (rowData) { return lodash.get(DYDICT.auditStatus, `${rowData.auditStatus}.label`); }}; 

COLUMNS.auditStatus = {"prop":"auditStatus","label":"审核状态","edit":false,"fixed":false,"formatter":function (rowData) { return lodash.get(DYDICT.auditStatus, `${rowData.auditStatus}.label`); }};
...
//字段type:字段类型
DYDICT.arr_type = [{"label":"文本输入框","value":"input"},{"label":"数字框","value":"number"},{"label":"数字范围","value":"numberRange"},{"label":"模糊查询文本框","value":"input_find_vague"},{"label":"文本域","value":"textarea"},{"label":"文本","value":"text"},{"label":"下拉框","value":"select"},{"label":"地区选项下拉框","value":"select_area"},{"label":"ajax懒加载下拉框(查询用)","value":"select_ajax_lazy"},{"label":"单选框","value":"radio"},{"label":"复选框","value":"checkbox"},{"label":"日期选择器","value":"date"},{"label":"日期时间选择器","value":"dateTime"},{"label":"对象字段","value":"object"},{"label":"json编辑器","value":"jsonEditor"},{"label":"json编辑器（加强版）","value":"vueJsonEditor"},{"label":"富文本编辑器","value":"editor"},{"label":"TinyMCE富文本编辑器","value":"editorTM"},{"label":"时间段查询框","value":"time_period"},{"label":"密码框","value":"password"},{"label":"多个图片/文件上传","value":"upload"},{"label":"单个文件上传","value":"upload_single"},{"label":"集合","value":"collection"},{"label":"标签列表","value":"tag_list"},{"label":"弹窗选择列表","value":"select_list_data"},{"label":"百分比滑块","value":"slider"},{"label":"树状数据","value":"tree_data"},{"label":"ajax填充","value":"ajax_populate"}];DYDICT.type = {"input":{"label":"文本输入框","value":"input"},"number":{"label":"数字框","value":"number"},"numberRange":{"label":"数字范围","value":"numberRange"},"input_find_vague":{"label":"模糊查询文本框","value":"input_find_vague"},"textarea":{"label":"文本域","value":"textarea"},"text":{"label":"文本","value":"text"},"select":{"label":"下拉框","value":"select"},"select_area":{"label":"地区选项下拉框","value":"select_area"},"select_ajax_lazy":{"label":"ajax懒加载下拉框(查询用)","value":"select_ajax_lazy"},"radio":{"label":"单选框","value":"radio"},"checkbox":{"label":"复选框","value":"checkbox"},"date":{"label":"日期选择器","value":"date"},"dateTime":{"label":"日期时间选择器","value":"dateTime"},"object":{"label":"对象字段","value":"object"},"jsonEditor":{"label":"json编辑器","value":"jsonEditor"},"vueJsonEditor":{"label":"json编辑器（加强版）","value":"vueJsonEditor"},"editor":{"label":"富文本编辑器","value":"editor"},"editorTM":{"label":"TinyMCE富文本编辑器","value":"editorTM"},"time_period":{"label":"时间段查询框","value":"time_period"},"password":{"label":"密码框","value":"password"},"upload":{"label":"多个图片/文件上传","value":"upload"},"upload_single":{"label":"单个文件上传","value":"upload_single"},"collection":{"label":"集合","value":"collection"},"tag_list":{"label":"标签列表","value":"tag_list"},"select_list_data":{"label":"弹窗选择列表","value":"select_list_data"},"slider":{"label":"百分比滑块","value":"slider"},"tree_data":{"label":"树状数据","value":"tree_data"},"ajax_populate":{"label":"ajax填充","value":"ajax_populate"}}; 
...
DYDICT.arr_equipment_type = [{"label":"大气压","value":1},{"label":"开关","value":2}];DYDICT.equipment_type = {"1":{"label":"大气压","value":1},"2":{"label":"开关","value":2}}; 
