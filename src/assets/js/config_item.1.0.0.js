...
window.styleMenuPowerItem = "margin-bottom:10px;padding:0 5px";
window.styleMenuGPowerItem = "margin-bottom:0;border:none;padding:0";
//函数定义：{获取菜单权限表单配置函数}
window.getFormMenuGPower = function (_ref) {
...
COLUMNS.timeOrder = { "prop": "timeOrder", "label": "下单时间", "edit": false, "fixed": false, "width": 130, "formatter": function formatter(row) {
    if (!row.timeOrder) return "";return moment(row.timeOrder).format("YYYY-MM-DD HH:mm");
  } };
...
COLUMNS.title_fixed_w380 = { "prop": "title", "label": "标题", "width": 380, "edit": false, "fixed": true };
...
//字段dataType:数据类型
DYDICT.arr_dataType = [{ "label": "知识点", "value": "note" }, { "label": "前端demo", "value": "front_demo" }, { "label": "习题", "value": "exercises" }, { "label": "分组", "value": "group" }, { "label": "HtmlApi", "value": "html_api" }, { "label": "Js-Api", "value": "js_api" }, { "label": "Css-Api", "value": "css_api" }, { "label": "视频", "value": "vedio" }, { "label": "网址", "value": "url" }, { "label": "文件", "value": "file" }, { "label": "图片", "value": "image" }];DYDICT.dataType = { "note": { "label": "知识点", "value": "note" }, "front_demo": { "label": "前端demo", "value": "front_demo" }, "exercises": { "label": "习题", "value": "exercises" }, "group": { "label": "分组", "value": "group" }, "html_api": { "label": "HtmlApi", "value": "html_api" }, "js_api": { "label": "Js-Api", "value": "js_api" }, "css_api": { "label": "Css-Api", "value": "css_api" }, "vedio": { "label": "视频", "value": "vedio" }, "url": { "label": "网址", "value": "url" }, "file": { "label": "文件", "value": "file" }, "image": { "label": "图片", "value": "image" } };
...
COLUMNS.payStatus_slot = { "prop": "payStatus", "label": "支付状态", "width": 130, "fixed": false, "edit": false, "slot": "slot_column_payStatus" };
...
F_ITEMS.prior = { "prop": "prior", "label": "优先级", "type": "select", "options": DYDICT.arr_prior };F_ITEMS.prior_radio = { "prop": "prior", "label": "优先级", "type": "radio", "options": DYDICT.arr_prior };
//字段taskType:任务类型
...
COLUMNS.complete = { "prop": "complete", "label": "完成度", "width": 80, "fixed": false, "edit": false, "slot": "slot_column_complete" };
COLUMNS.complete_com = { "prop": "complete", "label": "完成度", "width": 80, "fixed": false, "edit": false, "component": "com_complete" };

F_ITEMS.complete = { "prop": "complete", "label": "完成度", "type": "slider", "varType": "number", "default": 0, "options": DYDICT.arr_complete };
//字段complete2:完成情况
...
COLUMNS.familiarity_select = { "prop": "familiarity", "label": "熟悉度", "width": 80, "fixed": false, "edit": false, "component": "com_note_familiarity_select", "cfColumn": { "class-name": "table_cell_visible" } };
...
COLUMNS.myScore = { "prop": "myScore", "label": "我的分数", "width": 90, "fixed": false, "edit": false, "slot": "slot_column_score" };
...
COLUMNS.sort_edit = { "prop": "sort", "label": "序号", "width": 70, "fixed": false, "edit": true };
...
F_ITEMS.item_prop = { "prop": "prop", "label": "字段属性" };F_ITEMS.item_prop_search = { "prop": "prop", "label": "字段属性", "type": "input_find_vague" };
...
D_ITEMS.object_1 = { "prop": "object_1", "label": "对象字段" };

COLUMNS.object_1 = { "prop": "object_1", "label": "对象字段", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.object_1 = { "prop": "object_1", "label": "对象字段", "type": "object", "cfItem": { formItems: [{ label: "姓名", prop: "name" }, { label: "年龄", prop: "age" }] } };
...
F_ITEMS.diycheckbox = { "prop": "diycheckbox", "label": "diycheckbox", "slot": "slot_form_item_diycheckbox", "rules": [{ required: true, message: "不能为空" }] };
//字段num2:数字2
...
F_ITEMS.predictTime = { "prop": "predictTime", "label": "预估耗时", "type": "text", "frequency": { options: [{ value: 0.3 }, { value: 0.5 }, { value: 1 }, { value: 1.5 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }, { value: 8 }, { value: 10 }, { value: 12 }, { value: 14 }, { value: 16 }] } };
//字段actualTime:实耗时
...
F_ITEMS.actualTime = { "prop": "actualTime", "label": "实耗时", "type": "text", "frequency": { options: [{ value: 0.3 }, { value: 0.5 }, { value: 1 }, { value: 1.5 }, { value: 2 }, { value: 3 }, { value: 4 }, { value: 5 }, { value: 8 }, { value: 10 }, { value: 12 }, { value: 14 }, { value: 16 }] } };
//字段scoreKey:记分key
...
D_ITEMS.franchiseeId = { "prop": "franchiseeId", "label": "加盟商", "slot": "slot_detail_item_franchiseeId" };
...
F_ITEMS.area = { "prop": "area", "label": "所属地区", "slot": "slot_area", "rules": [{ required: true, message: "不能为空" }] };
//字段address:详细地址
...
D_ITEMS.album = { "prop": "album", "label": "相册", "slot": "slot_detail_item_album" };D_ITEMS.albumVenue = { "prop": "album", "label": "相册", "slot": "slot_detail_item_album" };
...
D_ITEMS.imagePreview = { "prop": "imagePreview", "label": "图片预览", "component": "com_imagePreview" };
...
D_ITEMS.menuIcon = { "prop": "icon", "label": "图标样式名" };

COLUMNS.menuIcon = { "prop": "icon", "label": "图标样式名", "width": 70, "edit": false, "fixed": false };

F_ITEMS.menuIcon = { "prop": "icon", "label": "图标样式名" };
//字段index:菜单索引值


D_ITEMS.index = { "prop": "index", "label": "菜单索引值" };

COLUMNS.menuIndex = { "prop": "index", "label": "菜单索引值", "width": 70, "edit": false, "fixed": false };

F_ITEMS.menuIndex = { "prop": "index", "label": "菜单索引值", "tips": "该值不允许重复" };
//字段route:路由地址


D_ITEMS.route = { "prop": "route", "label": "路由地址" };

COLUMNS.menuRoute = { "prop": "route", "label": "路由地址", "width": 70, "edit": false, "fixed": false };

F_ITEMS.menuRoute = { "prop": "route", "label": "路由地址" };
//字段treeData1:树状数据
...
F_ITEMS._systemId = { "prop": "_systemId", "label": "系统Id", "type": "select", "ajax": { param: { _dataType: "system" }, url: "/info/getCommonList", keyLabel: "title", keyValue: "systemId" }, "multiple": true };
//字段iconSrc:icon地址
...
//字段varType:JS数据类型
DYDICT.arr_varType = [{ "label": "字符串", "value": "string" }, { "label": "数值", "value": "number" }, { "label": "布尔", "value": "boolean" }, { "label": "对象", "value": "object" }, { "label": "数组", "value": "array" }, { "label": "函数", "value": "function" }, { "label": "js脚本", "value": "jsCode" }];DYDICT.varType = { "string": { "label": "字符串", "value": "string" }, "number": { "label": "数值", "value": "number" }, "boolean": { "label": "布尔", "value": "boolean" }, "object": { "label": "对象", "value": "object" }, "array": { "label": "数组", "value": "array" }, "function": { "label": "函数", "value": "function" }, "jsCode": { "label": "js脚本", "value": "jsCode" } };

D_ITEMS.varType = { "prop": "varType", "label": "JS数据类型" };

COLUMNS.varType = { "prop": "varType", "label": "JS数据类型", "width": 70, "edit": false, "fixed": false };

F_ITEMS.varType = { "prop": "varType", "label": "JS数据类型", "type": "select", "options": DYDICT.arr_varType };
//字段cfDict:静态数据字典配置


D_ITEMS.cfDict = { "prop": "cfDict", "label": "静态数据字典配置" };

COLUMNS.cfDict = { "prop": "cfDict", "label": "静态数据字典配置", "edit": false, "fixed": false };

F_ITEMS.cfDict = { "prop": "cfDict", "label": "静态数据字典配置", "cfForm": { col_span: 8, formItems: [F_ITEMS.varType, F_ITEMS.collection_DYDICT_value] }, "default": {} };
//字段objAddonItem:附加字段


D_ITEMS.objAddonItem = { "prop": "objAddonItem", "label": "附加字段" };

COLUMNS.objAddonItem = { "prop": "objAddonItem", "label": "附加字段", "edit": false, "fixed": false };

F_ITEMS.objAddonItem = { "prop": "objAddonItem", "label": "附加字段", "col_span": 24, "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: false }, "collectionCfForm": { col_span: 12, formItems: [{ label: "字段key", prop: "key" }, { label: "字段说明", prop: "desc" }, F_ITEMS.varType, { label: "字段值", prop: "value", type: "textarea" }] } };
//字段populateColumn:填充列key


D_ITEMS.dyDict_populateColumn = { "prop": "populateColumn", "label": "填充列key" };

COLUMNS.dyDict_populateColumn = { "prop": "populateColumn", "label": "填充列key", "edit": false, "fixed": false };

F_ITEMS.dyDict_populateColumn = { "prop": "populateColumn", "label": "填充列key" };
//字段idColumn:idColumn


D_ITEMS.dyDict_idColumn = { "prop": "idColumn", "label": "idColumn" };

COLUMNS.dyDict_idColumn = { "prop": "idColumn", "label": "idColumn", "width": 70, "edit": false, "fixed": false };

F_ITEMS.dyDict_idColumn = { "prop": "idColumn", "label": "idColumn" };
//字段idColumn2:idColumn


D_ITEMS.dyDict_idColumn2 = { "prop": "idColumn2", "label": "idColumn" };

COLUMNS.dyDict_idColumn2 = { "prop": "idColumn2", "label": "idColumn", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.dyDict_idColumn2 = { "prop": "idColumn2", "label": "idColumn" };
//字段param:ajax参数


D_ITEMS.dyDict_ajax_param = { "prop": "param", "label": "ajax参数" };

COLUMNS.dyDict_ajax_param = { "prop": "param", "label": "ajax参数", "width": 70, "edit": false, "fixed": false };

F_ITEMS.dyDict_ajax_param = { "prop": "param", "label": "ajax参数", "type": "jsonEditor" };
//字段url:ajax地址


D_ITEMS.dyDict_ajax_url = { "prop": "url", "label": "ajax地址" };

COLUMNS.dyDict_ajax_url = { "prop": "url", "label": "ajax地址", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.dyDict_ajax_url = { "prop": "url", "label": "ajax地址", "type": "" };
//字段ajax:ajax配置


D_ITEMS.dyDict_ajax = { "prop": "ajax", "label": "ajax配置" };

COLUMNS.dyDict_ajax = { "prop": "ajax", "label": "ajax配置", "width": 70, "edit": false, "fixed": false };

F_ITEMS.dyDict_ajax = { "prop": "ajax", "label": "ajax配置", "col_span": 24, "default": {}, "cfForm": { col_span: 8, formItems: [F_ITEMS.dyDict_ajax_param, F_ITEMS.dyDict_ajax_url] } };
//字段cfDyDict:动态数据字典配置


D_ITEMS.cfDyDict = { "prop": "cfDyDict", "label": "动态数据字典配置" };

COLUMNS.cfDyDict = { "prop": "cfDyDict", "label": "动态数据字典配置", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.cfDyDict = { "prop": "cfDyDict", "label": "动态数据字典配置", "col_span": 24, "default": {}, "cfForm": { col_span: 8, formItems: [F_ITEMS.dyDict_populateColumn, F_ITEMS.dyDict_idColumn, F_ITEMS.dyDict_idColumn2, F_ITEMS.dyDict_ajax] } };
//字段type:字段类型
DYDICT.arr_type = [{ "label": "文本输入框", "value": "input" }, { "label": "数字框", "value": "number" }, { "label": "数字范围", "value": "numberRange" }, { "label": "模糊查询文本框", "value": "input_find_vague" }, { "label": "文本域", "value": "textarea" }, { "label": "文本", "value": "text" }, { "label": "下拉框", "value": "select" }, { "label": "地区选项下拉框", "value": "select_area" }, { "label": "ajax懒加载下拉框(查询用)", "value": "select_ajax_lazy" }, { "label": "单选框", "value": "radio" }, { "label": "复选框", "value": "checkbox" }, { "label": "日期选择器", "value": "date" }, { "label": "日期时间选择器", "value": "dateTime" }, { "label": "对象字段", "value": "object" }, { "label": "json编辑器", "value": "jsonEditor" }, { "label": "json编辑器（加强版）", "value": "vueJsonEditor" }, { "label": "codemirror代码编辑器", "value": "codemirror" }, { "label": "富文本编辑器", "value": "editor" }, { "label": "TinyMCE富文本编辑器", "value": "editorTM" }, { "label": "时间段查询框", "value": "time_period" }, { "label": "密码框", "value": "password" }, { "label": "多个图片/文件上传", "value": "upload" }, { "label": "单个文件上传", "value": "upload_single" }, { "label": "集合", "value": "collection" }, { "label": "标签列表", "value": "tag_list" }, { "label": "弹窗选择列表", "value": "select_list_data" }, { "label": "百分比滑块", "value": "slider" }, { "label": "树状数据", "value": "tree_data" }, { "label": "ajax填充", "value": "ajax_populate" }];DYDICT.type = { "input": { "label": "文本输入框", "value": "input" }, "number": { "label": "数字框", "value": "number" }, "numberRange": { "label": "数字范围", "value": "numberRange" }, "input_find_vague": { "label": "模糊查询文本框", "value": "input_find_vague" }, "textarea": { "label": "文本域", "value": "textarea" }, "text": { "label": "文本", "value": "text" }, "select": { "label": "下拉框", "value": "select" }, "select_area": { "label": "地区选项下拉框", "value": "select_area" }, "select_ajax_lazy": { "label": "ajax懒加载下拉框(查询用)", "value": "select_ajax_lazy" }, "radio": { "label": "单选框", "value": "radio" }, "checkbox": { "label": "复选框", "value": "checkbox" }, "date": { "label": "日期选择器", "value": "date" }, "dateTime": { "label": "日期时间选择器", "value": "dateTime" }, "object": { "label": "对象字段", "value": "object" }, "jsonEditor": { "label": "json编辑器", "value": "jsonEditor" }, "vueJsonEditor": { "label": "json编辑器（加强版）", "value": "vueJsonEditor" }, "codemirror": { "label": "codemirror代码编辑器", "value": "codemirror" }, "editor": { "label": "富文本编辑器", "value": "editor" }, "editorTM": { "label": "TinyMCE富文本编辑器", "value": "editorTM" }, "time_period": { "label": "时间段查询框", "value": "time_period" }, "password": { "label": "密码框", "value": "password" }, "upload": { "label": "多个图片/文件上传", "value": "upload" }, "upload_single": { "label": "单个文件上传", "value": "upload_single" }, "collection": { "label": "集合", "value": "collection" }, "tag_list": { "label": "标签列表", "value": "tag_list" }, "select_list_data": { "label": "弹窗选择列表", "value": "select_list_data" }, "slider": { "label": "百分比滑块", "value": "slider" }, "tree_data": { "label": "树状数据", "value": "tree_data" }, "ajax_populate": { "label": "ajax填充", "value": "ajax_populate" } };

D_ITEMS.item_type = { "prop": "type", "label": "字段类型" };D_ITEMS.fItemType = { "prop": "type", "label": "字段类型" };

COLUMNS.item_type = { "prop": "type", "label": "字段类型", "fixed": false, "edit": false, "width": 70 };
COLUMNS.fItemType = { "prop": "type", "label": "字段类型", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.item_type = { "prop": "type", "label": "字段类型" };F_ITEMS.fItemType = { "prop": "type", "label": "字段类型", "type": "select", "options": DYDICT.arr_type };
//字段component:组件com


D_ITEMS.componentName = { "prop": "component", "label": "组件com" };

COLUMNS.componentName = { "prop": "component", "label": "组件com", "width": 70, "edit": false, "fixed": false };

F_ITEMS.componentName = { "prop": "component", "label": "组件com" };
//字段slot:插槽slot


D_ITEMS.slotName = { "prop": "slot", "label": "插槽slot" };

COLUMNS.slotName = { "prop": "slot", "label": "插槽slot", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.slotName = { "prop": "slot", "label": "插槽slot" };
//字段formatter:formatter函数


D_ITEMS.formatter = { "prop": "formatter", "label": "formatter函数" };

COLUMNS.formatter = { "prop": "formatter", "label": "formatter函数", "width": 70, "edit": false, "fixed": false };

F_ITEMS.formatter = { "prop": "formatter", "label": "formatter函数", "type": "textarea" };
//字段default:默认值


D_ITEMS.defaultValue = { "prop": "default", "label": "默认值" };

COLUMNS.defaultValue = { "prop": "default", "label": "默认值", "width": 70, "edit": false, "fixed": false };

F_ITEMS.defaultValue = { "prop": "default", "label": "默认值", "type": "textarea" };
//字段col_span:字段跨度


D_ITEMS.item_col_span = { "prop": "col_span", "label": "字段跨度" };

COLUMNS.item_col_span = { "prop": "col_span", "label": "字段跨度", "width": 70, "edit": false, "fixed": false };

F_ITEMS.item_col_span = { "prop": "col_span", "label": "字段跨度", "type": "number" };
//字段width:宽度


D_ITEMS.item_width = { "prop": "width", "label": "列宽" };

COLUMNS.item_width = { "prop": "width", "label": "列宽", "width": 70, "edit": false, "fixed": false };

F_ITEMS.item_width = { "prop": "width", "label": "列宽", "type": "number" };
//字段edit:可编辑


D_ITEMS.c_item_edit = { "prop": "edit", "label": "可编辑" };

COLUMNS.c_item_edit = { "prop": "edit", "label": "可编辑", "width": 70, "edit": false, "fixed": false };

F_ITEMS.c_item_edit = { "prop": "edit", "label": "可编辑", "type": "checkbox", "default": false, "options": [{ value: "1", label: "" }] };
//字段fixed:固定列


D_ITEMS.c_item_fixed = { "prop": "fixed", "label": "固定列" };

COLUMNS.c_item_fixed = { "prop": "fixed", "label": "固定列", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.c_item_fixed = { "prop": "fixed", "label": "固定列", "type": "checkbox", "default": false, "options": [{ value: "1", label: "" }] };
//字段xxx:xxx


D_ITEMS.xxx = { "prop": "xxx", "label": "xxx" };

COLUMNS.xxx = { "prop": "xxx", "label": "xxx", "width": 70, "fixed": false, "edit": false };

F_ITEMS.xxx = { "prop": "xxx", "label": "xxx" };
//字段cfElCarousel:饿了么走马灯配置


D_ITEMS.cfElCarousel = { "prop": "cfElCarousel", "label": "饿了么走马灯配置" };

COLUMNS.cfElCarousel = { "prop": "cfElCarousel", "label": "饿了么走马灯配置", "edit": false, "fixed": false, "width": 70 };

F_ITEMS.cfElCarousel = { "prop": "cfElCarousel", "label": "饿了么走马灯配置", "type": "object", "cfItem": { formItems: [{ label: "高度px", prop: "height" }, { label: "时间间隔（毫秒）", prop: "interval", type: "number" }] } };
//字段list:列表


F_ITEMS.listNews2 = { "prop": "list", "label": "首页-行业新闻列表", "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: true }, "collectionCfForm": { col_span: 12, formItems: [{ label: "标题", prop: "title" }, { label: "链接", prop: "link" }, { label: "图片地址", prop: "imgSrc" }, { label: "描述", prop: "desc" }] } };F_ITEMS.listSchoolNews = { "prop": "list", "label": "首页-学校新闻列表", "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: true }, "collectionCfForm": { col_span: 12, formItems: [{ label: "标题", prop: "title" }, { label: "链接", prop: "link" }, { label: "图片地址", prop: "imgSrc" }, { label: "描述", prop: "desc" }] } };F_ITEMS.listTeacher = { "prop": "list", "label": "首页-老师列表", "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: true }, "collectionCfForm": { col_span: 12, formItems: [{ label: "标题", prop: "title" }, { label: "链接", prop: "link" }, { label: "图片地址", prop: "imgSrc" }, { label: "描述", prop: "desc" }] } };F_ITEMS.listCourse = { "prop": "list", "label": "课程列表", "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: true }, "collectionCfForm": { col_span: 12, formItems: [{ label: "标题", prop: "title" }, { label: "链接", prop: "link" }, { label: "图片地址", prop: "imgSrc" }, { label: "销售价", prop: "priceSell" }, { label: "市场价", prop: "priceMarket" }] } };F_ITEMS.listCarouselImg = { "prop": "list", "label": "图片列表", "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "large", plain: false }, "collectionCfForm": { col_span: 12, formItems: [{ label: "标题", prop: "title" }, { label: "链接", prop: "link" }, { label: "图片地址", prop: "imgSrc" }] } };
//字段cfBanner:banner图配置


D_ITEMS.cfBanner = { "prop": "cfBanner", "label": "banner图配置" };

COLUMNS.cfBanner = { "prop": "cfBanner", "label": "banner图配置", "width": 70, "fixed": false, "edit": false };

F_ITEMS.cfBanner = { "prop": "cfBanner", "label": "首页-banner图配置", "type": "object", "cfItem": { formItems: [F_ITEMS.cfElCarousel, F_ITEMS.listCarouselImg] } };
//字段cfCourse:课程列表配置


D_ITEMS.cfCourse = { "prop": "cfCourse", "label": "课程列表配置" };

COLUMNS.cfCourse = { "prop": "cfCourse", "label": "课程列表配置", "edit": false, "fixed": false, "width": 70 };

F_ITEMS.cfCourse = { "prop": "cfCourse", "label": "首页-课程列表配置", "type": "object", "cfItem": { formItems: [F_ITEMS.title, F_ITEMS.listCourse] } };
//字段cfTeacher:老师列表配置


D_ITEMS.cfTeacher = { "prop": "cfTeacher", "label": "老师列表配置" };

COLUMNS.cfTeacher = { "prop": "cfTeacher", "label": "老师列表配置", "width": 70, "fixed": false, "edit": false };

F_ITEMS.cfTeacher = { "prop": "cfTeacher", "label": "首页-老师列表配置", "type": "object", "cfItem": { formItems: [F_ITEMS.title, F_ITEMS.listTeacher] } };
//字段cfSchoolNews:学校新闻列表配置


D_ITEMS.cfSchoolNews = { "prop": "cfSchoolNews", "label": "学校新闻列表配置" };

COLUMNS.cfSchoolNews = { "prop": "cfSchoolNews", "label": "学校新闻列表配置", "edit": false, "fixed": false, "width": 70 };

F_ITEMS.cfSchoolNews = { "prop": "cfSchoolNews", "label": "首页-学校新闻配置", "type": "object", "cfItem": { formItems: [F_ITEMS.title, F_ITEMS.listSchoolNews] } };
//字段cfNews2:行业新闻列表配置


D_ITEMS.cfNews2 = { "prop": "cfNews2", "label": "行业新闻列表配置" };

COLUMNS.cfNews2 = { "prop": "cfNews2", "label": "行业新闻列表配置", "width": 70, "fixed": false, "edit": false };

F_ITEMS.cfNews2 = { "prop": "cfNews2", "label": "首页-行业新闻配置", "type": "object", "cfItem": { formItems: [F_ITEMS.title, F_ITEMS.listNews2] } };
//字段equipment_state:设备状态
DYDICT.arr_equipment_state = [{ "label": "离线", "value": 0 }, { "label": "在线", "value": 1 }, { "label": "异常", "value": 2 }];DYDICT.equipment_state = { "0": { "label": "离线", "value": 0 }, "1": { "label": "在线", "value": 1 }, "2": { "label": "异常", "value": 2 } };

//字段equipment_type:设备类型
DYDICT.arr_equipment_type = [{ "label": "灯控", "value": 4 }, { "label": "锁", "value": 5 }, { "label": "开关", "value": 6 }, { "label": "温室控制网关", "value": 7 }, { "label": "抽风机", "value": 8 }, { "label": "水位", "value": 9 }, { "label": "摄像头", "value": 10 }, { "label": "遮阳帘", "value": 11 }, { "label": "加湿机", "value": 12 }, { "label": "水肥桶", "value": 13 }, { "label": "水泵", "value": 14 }, { "label": "阀门", "value": 15 }, { "label": "风速", "value": 160 }, { "label": "风向", "value": 161 }, { "label": "PM10", "value": 162 }, { "label": "PM2.5", "value": 163 }, { "label": "噪声", "value": 164 }, { "label": "空气温湿度", "value": 165 }, { "label": "土壤温湿度", "value": 166 }, { "label": "CO2浓度", "value": 167 }, { "label": "O2", "value": 168 }, { "label": "降雨量", "value": 169 }, { "label": "大气压", "value": 170 }, { "label": "光照度", "value": 171 }, { "label": "EC", "value": 172 }, { "label": "PH", "value": 173 }, { "label": "氮", "value": 174 }, { "label": "磷", "value": 175 }, { "label": "钾", "value": 176 }, { "label": "CO", "value": 177 }, { "label": "SO2", "value": 178 }, { "label": "NO2", "value": 179 }, { "label": "O3", "value": 180 }, { "label": "氨气", "value": 181 }, { "label": "硫化氢", "value": 182 }, { "label": "氨氮", "value": 183 }, { "label": "溶氧度", "value": 184 }, { "label": "浑浊度", "value": 185 }, { "label": "空气湿度", "value": 265 }, { "label": "土壤湿度", "value": 266 }];DYDICT.equipment_type = { "4": { "label": "灯控", "value": 4 }, "5": { "label": "锁", "value": 5 }, "6": { "label": "开关", "value": 6 }, "7": { "label": "温室控制网关", "value": 7 }, "8": { "label": "抽风机", "value": 8 }, "9": { "label": "水位", "value": 9 }, "10": { "label": "摄像头", "value": 10 }, "11": { "label": "遮阳帘", "value": 11 }, "12": { "label": "加湿机", "value": 12 }, "13": { "label": "水肥桶", "value": 13 }, "14": { "label": "水泵", "value": 14 }, "15": { "label": "阀门", "value": 15 }, "160": { "label": "风速", "value": 160 }, "161": { "label": "风向", "value": 161 }, "162": { "label": "PM10", "value": 162 }, "163": { "label": "PM2.5", "value": 163 }, "164": { "label": "噪声", "value": 164 }, "165": { "label": "空气温湿度", "value": 165 }, "166": { "label": "土壤温湿度", "value": 166 }, "167": { "label": "CO2浓度", "value": 167 }, "168": { "label": "O2", "value": 168 }, "169": { "label": "降雨量", "value": 169 }, "170": { "label": "大气压", "value": 170 }, "171": { "label": "光照度", "value": 171 }, "172": { "label": "EC", "value": 172 }, "173": { "label": "PH", "value": 173 }, "174": { "label": "氮", "value": 174 }, "175": { "label": "磷", "value": 175 }, "176": { "label": "钾", "value": 176 }, "177": { "label": "CO", "value": 177 }, "178": { "label": "SO2", "value": 178 }, "179": { "label": "NO2", "value": 179 }, "180": { "label": "O3", "value": 180 }, "181": { "label": "氨气", "value": 181 }, "182": { "label": "硫化氢", "value": 182 }, "183": { "label": "氨氮", "value": 183 }, "184": { "label": "溶氧度", "value": 184 }, "185": { "label": "浑浊度", "value": 185 }, "265": { "label": "空气湿度", "value": 265 }, "266": { "label": "土壤湿度", "value": 266 } };

//字段equipment_state_class:设备状态class名
DYDICT.arr_equipment_state_class = [{ "label": "offline", "value": 0 }, { "label": "online", "value": 1 }, { "label": "abnormal", "value": 2 }];DYDICT.equipment_state_class = { "0": { "label": "offline", "value": 0 }, "1": { "label": "online", "value": 1 }, "2": { "label": "abnormal", "value": 2 } };
...
COLUMNS.orderGoodsDesc = { "prop": "orderGoodsDesc", "label": "商品说明", "edit": false, "fixed": false, "width": 220 };

F_ITEMS.orderGoodsDesc = { "prop": "orderGoodsDesc", "label": "商品说明" };F_ITEMS.orderGoodsDesc_search = { "prop": "orderGoodsDesc", "label": "商品说明", "type": "input_find_vague" };
//字段countJsCode:子代码块数


D_ITEMS.countJsCode = { "prop": "countJsCode", "label": "子代码块数" };

COLUMNS.countJsCode = { "prop": "countJsCode", "label": "子代码块数", "edit": false, "fixed": false, "width": 110, "formatter": function formatter(rowData) {
    return lodash.get(rowData.relJsCode, "length", 0);
  }, "requireProp": ["relJsCode"] };

F_ITEMS.countJsCode = { "prop": "countJsCode", "label": "子代码块数" };
//字段versionNum:版本号


D_ITEMS.versionNum = { "prop": "versionNum", "label": "版本号" };

COLUMNS.versionNum = { "prop": "versionNum", "label": "版本号", "width": 70, "fixed": false, "edit": false };

F_ITEMS.versionNum = { "prop": "versionNum", "label": "版本号", "type": "number" };
//字段timeAppointVisit:预约上门时间


D_ITEMS.timeAppointVisit = { "prop": "timeAppointVisit", "label": "预约上门时间", "formatter": function formatter(row) {
    if (!row.timeOrder) return "";return moment(row.timeAppointVisit).format("YYYY-MM-DD HH:mm");
  } };

COLUMNS.timeAppointVisit = { "prop": "timeAppointVisit", "label": "预约上门时间", "width": 130, "fixed": false, "edit": false, "formatter": function formatter(row) {
    if (!row.timeOrder) return "";return moment(row.timeAppointVisit).format("YYYY-MM-DD HH:mm");
  } };

F_ITEMS.timeAppointVisit = { "prop": "timeAppointVisit", "label": "预约上门时间", "type": "dateTime", "varType": "string" };F_ITEMS.timeAppointVisit_search = { "prop": "timeAppointVisit", "label": "预约上门时间", "type": "time_period", "varType": "string" };
//字段timeTrueVisit:真实上门时间


D_ITEMS.timeTrueVisit = { "prop": "timeTrueVisit", "label": "真实上门时间", "formatter": function formatter(row) {
    if (!row.timeOrder) return "";return moment(row.timeAppointVisit).format("YYYY-MM-DD HH:mm");
  } };

COLUMNS.timeTrueVisit = { "prop": "timeTrueVisit", "label": "真实上门时间", "edit": false, "fixed": false, "width": 130, "formatter": function formatter(row) {
    if (!row.timeOrder) return "";return moment(row.timeAppointVisit).format("YYYY-MM-DD HH:mm");
  } };

F_ITEMS.timeTrueVisit = { "prop": "timeTrueVisit", "label": "真实上门时间", "varType": "string", "type": "dateTime" };F_ITEMS.timeTrueVisit_search = { "prop": "timeTrueVisit", "label": "真实上门时间", "varType": "string", "type": "time_period" };
//字段visitServiceStatus:服务状态
DYDICT.arr_visitServiceStatus = [{ "label": "未预约", "value": 1 }, { "label": "已预约未上门", "value": 2 }, { "label": "已上门", "value": 3 }, { "label": "其他", "value": 4 }];DYDICT.visitServiceStatus = { "1": { "label": "未预约", "value": 1 }, "2": { "label": "已预约未上门", "value": 2 }, "3": { "label": "已上门", "value": 3 }, "4": { "label": "其他", "value": 4 } };

D_ITEMS.visitServiceStatus = { "prop": "visitServiceStatus", "label": "服务状态", "formatter": function formatter(rowData) {
    return lodash.get(DYDICT.visitServiceStatus, rowData.visitServiceStatus + ".label");
  } };

COLUMNS.visitServiceStatus = { "prop": "visitServiceStatus", "label": "服务状态", "fixed": false, "edit": false, "width": 80, "formatter": function formatter(rowData) {
    return lodash.get(DYDICT.visitServiceStatus, rowData.visitServiceStatus + ".label");
  } };

F_ITEMS.visitServiceStatus = { "prop": "visitServiceStatus", "label": "服务状态", "type": "select", "options": DYDICT.visitServiceStatus };
//字段serviceWorker:施工人员


D_ITEMS.serviceWorker = { "prop": "serviceWorker", "label": "施工人员" };

COLUMNS.serviceWorker = { "prop": "serviceWorker", "label": "施工人员", "edit": false, "fixed": false, "width": 90 };

F_ITEMS.serviceWorker = { "prop": "serviceWorker", "label": "施工人员" };
//字段serviceRemark:施工备注


D_ITEMS.serviceRemark = { "prop": "serviceRemark", "label": "施工备注" };

COLUMNS.serviceRemark = { "prop": "serviceRemark", "label": "施工备注", "width": 100, "fixed": false, "edit": false };

F_ITEMS.serviceRemark = { "prop": "serviceRemark", "label": "施工备注" };
//字段operateRelData:操作关系数据


COLUMNS.operateRelData = { "prop": "operateRelData", "label": "操作关系数据", "component": "com_column_operate_rel_data", "edit": false, "fixed": false, "width": 100 };

//字段operateEntityData:操作


COLUMNS.operateEntityData = { "prop": "operateEntityData", "label": "操作", "fixed": false, "edit": false, "component": "com_column_operate_entity_data", "min-width": 100 };

//字段resource_type_id:智慧耕资产类型Id
DYDICT.arr_resource_type_id = [{ "label": "果园", "value": 1 }, { "label": "菜地", "value": 2 }, { "label": "养殖场", "value": 3 }];DYDICT.resource_type_id = { "1": { "label": "果园", "value": 1 }, "2": { "label": "菜地", "value": 2 }, "3": { "label": "养殖场", "value": 3 } };

//字段caseStatus:案件状态
DYDICT.arr_caseStatus = [{ "label": "审理", "value": 1 }, { "label": "结案", "value": 2 }, { "label": "归档", "value": 3 }, { "label": "其他", "value": 4 }];DYDICT.caseStatus = { "1": { "label": "审理", "value": 1 }, "2": { "label": "结案", "value": 2 }, "3": { "label": "归档", "value": 3 }, "4": { "label": "其他", "value": 4 } };

//字段arrCfDItem:详情配置集合


D_ITEMS.arrCfDItem = { "prop": "arrCfDItem", "label": "详情配置集合" };

COLUMNS.arrCfDItem = { "prop": "arrCfDItem", "label": "详情配置集合", "width": 70, "edit": false, "fixed": false };

F_ITEMS.arrCfDItem = { "prop": "arrCfDItem", "label": "详情配置集合", "col_span": 24, "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: false }, "collectionCfForm": { col_span: 6, formItems: [F_ITEMS.item_prop, F_ITEMS.item_label, F_ITEMS.slotName, F_ITEMS.componentName, F_ITEMS.formatter, F_ITEMS.objAddonItem] } };
//字段arrCfCItem:列字段集合


D_ITEMS.arrCfCItem = { "prop": "arrCfCItem", "label": "列字段集合" };

COLUMNS.arrCfCItem = { "prop": "arrCfCItem", "label": "列字段集合", "fixed": false, "edit": false, "width": 70 };

F_ITEMS.arrCfCItem = { "prop": "arrCfCItem", "label": "列字段集合", "type": "collection", "col_span": 24, "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: false }, "collectionCfForm": { col_span: 6, formItems: [F_ITEMS.item_prop, F_ITEMS.item_label, F_ITEMS.slotName, F_ITEMS.componentName, F_ITEMS.formatter, F_ITEMS.item_width, F_ITEMS.c_item_edit, F_ITEMS.c_item_fixed, F_ITEMS.objAddonItem] } };
//字段arrCfFItem:表单字段集合


D_ITEMS.arrCfFItem = { "prop": "arrCfFItem", "label": "表单字段集合" };

COLUMNS.arrCfFItem = { "prop": "arrCfFItem", "label": "表单字段集合", "width": 70, "edit": false, "fixed": false };

F_ITEMS.arrCfFItem = { "prop": "arrCfFItem", "label": "表单字段集合", "col_span": 24, "type": "collection", "cfElBtnAdd": { text: "+添加一组", type: "primary", size: "mini", plain: false }, "collectionCfForm": { col_span: 6, formItems: [F_ITEMS.item_prop, F_ITEMS.item_label, F_ITEMS.fItemType, F_ITEMS.slotName, F_ITEMS.item_col_span, F_ITEMS.componentName, F_ITEMS.objAddonItem] } };