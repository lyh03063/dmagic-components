...
COLUMNS.personCharge = {
    ...
    formatter(row) {//返回姓名-配合动态数据字典
        ...
        let arr1 = util.clearArr(row.adminDoc); //调用：{清除数组中的无效元素（null,undefined,空格等）}
...
COLUMNS.timeOrder = { ...D_ITEMS.timeOrder };
F_ITEMS.timeOrder__search = { ...D_ITEMS.timeOrder, type: "time_period", };
...
//#region icon地址
{
    ...
    F_ITEMS.iconSrc = { ...objBase, type: "upload_single" };
}
