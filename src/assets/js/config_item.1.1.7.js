...
F_ITEMS.detail_paste={...F_ITEMS.detail,pasteImage: true}//支持粘贴上传图片的编辑器
...
COLUMNS.address = { ...D_ITEMS.address, width: 70, };
F_ITEMS.address = {
    ...D_ITEMS.address,
    rules: [{ required: true, message: "不能为空" }]
};
