...
<template>
  <div id="calendar" :class="{'change':isChange}">
    ...
    <el-button plain @click="rightSliding" size="mini">-></el-button>
...
#calendar .year-month .year-month_left {
  height: 100%;
  width: 80%;
  padding-left: 25px;
  display: flex;
...
#calendar .year-month .year-month_left .top-time {
  color: #333;
  font-size: 26px;
  font-weight: 500;
  margin-right: 15px;
}
#calendar .year-month .year-month_left ul {
  display: flex;
  flex-direction: column;
}
#calendar .year-month .year-month_left ul li {
  color: #444;
  font-size: 16px;
}
#calendar .year-month .year-month_right {
  height: 100%;
  width: 20%;
  display: flex;
  align-items: center;
...
#calendar .year-month .year-month_right .i-plus-empty {
  fill: #f18d2f;
}
#calendar .weekdays {
  margin: 0;
...
#calendar .background .dbg {
  background-color: #e1e1e1;
  height: 42.2px;
}
#calendar .background .lbg {
